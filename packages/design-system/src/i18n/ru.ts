...
export const ru: Messages = {
  ...
  flowCanvas: {
    ...
    instructions:
      'Используйте стрелки для перехода между узлами, Home и End — первый и последний узел. Enter — открыть узел, Delete — удалить, Shift со стрелкой — переместить. E — перебор связей узла, C — новая связь, Escape — отмена или снятие выделения. Масштаб — плюс и минус, 0 — вписать диаграмму, Control со стрелкой — панорамирование.',
    instructionsReadOnly:
      'Используйте стрелки для перехода между узлами, Home и End — первый и последний узел. Enter — открыть узел, E — перебор связей узла, Escape — снятие выделения. Масштаб — плюс и минус, 0 — вписать диаграмму, Control со стрелкой — панорамирование.',
    nodeRole: 'узел',
    edgeRole: 'связь',
    zoomIn: 'Приблизить',
    zoomOut: 'Отдалить',
