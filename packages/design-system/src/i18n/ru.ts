...
export const ru: Messages = {
  ...
  calendar: {
    ...
    dragInstructions:
      'Событие можно перетаскивать. Alt со стрелками вверх или вниз — перенести событие, Alt со стрелками влево или вправо — перенести в другую колонку, Alt+Shift со стрелками вверх или вниз — изменить время окончания.',
  },
  datePicker: {
    today: 'Сегодня',
    clear: 'Очистить',
