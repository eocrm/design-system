...
| Wiring             | Extract `Field`'s wiring to `_internal/fieldWiring.tsx`, consumed by both | The `                                                                                                                                                                                                                    |     | `-not-`??` rule for empty ARIA id lists is subtle, hard-won and commented. Copying 20 lines of it is how it drifts. |
