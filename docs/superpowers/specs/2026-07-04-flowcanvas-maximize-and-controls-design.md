...
2. Else **cancel an in-progress connection drag** _(existing behavior)_.
3. Else **clear the selection** _(existing behavior)_.
4. Else if **maximized → exit maximize** _(new final tier)_.
