...
.content.side-right[data-state='closed'] { transform: translateX(100%); }
...
.content.side-left[data-state='closed'] { transform: translateX(-100%); }
...
.content.side-top[data-state='closed'] { transform: translateY(-100%); }
...
.content.side-bottom[data-state='closed'] { transform: translateY(100%); }
// stylelint-enable property-disallowed-list
...
function SidesExample() {
  ...
  return (
    ...
    >
      <Cluster gap="sm">
        <Button variant="secondary" size="sm" onClick={() => setSide('left')}>Left</Button>
        <Button variant="secondary" size="sm" onClick={() => setSide('right')}>Right</Button>
        <Button variant="secondary" size="sm" onClick={() => setSide('top')}>Top</Button>
        <Button variant="secondary" size="sm" onClick={() => setSide('bottom')}>Bottom</Button>
      </Cluster>
...
function SizesExample() {
  ...
  return (
    ...
    >
      <Cluster gap="sm">
        <Button variant="secondary" size="sm" onClick={() => setSize('sm')}>Small</Button>
        <Button variant="secondary" size="sm" onClick={() => setSize('md')}>Medium</Button>
        <Button variant="secondary" size="sm" onClick={() => setSize('lg')}>Large</Button>
      </Cluster>
...
function OverlayVariantsExample() {
  ...
  return (
    ...
    >
      <Cluster gap="sm">
        <Button variant="secondary" size="sm" onClick={() => setVariant('solid')}>Solid overlay</Button>
        <Button variant="secondary" size="sm" onClick={() => setVariant('blur')}>Blur overlay</Button>
      </Cluster>
      <Drawer open={variant !== null} onOpenChange={(n) => !n && setVariant(null)} overlay={variant ?? 'solid'}>
        <Drawer.Header>{variant === 'blur' ? 'Frosted glass' : 'Solid dim'}</Drawer.Header>
        <Drawer.Body>{variant === 'blur' ? 'Backdrop is blurred.' : 'Standard dimming overlay.'}</Drawer.Body>
      </Drawer>
    </Example>
  );
}
...
function ForcedStepExample() {
  ...
  return (
    ...
    >
      <Cluster>
        <Button variant="danger" onClick={() => setOpen(true)}>Trigger forced step</Button>
      </Cluster>
      <Drawer
        open={open}
        onOpenChange={() => {}}
...
<Drawer open={confirmOpen} ...>...</Drawer>`}
    >
      ...
      <Drawer open={confirmOpen} onOpenChange={setConfirmOpen} size="sm">
        ...
        <Drawer.Footer>
          <Drawer.Close><Button variant="secondary">Cancel</Button></Drawer.Close>
          <Button variant="danger" onClick={() => { setConfirmOpen(false); setEditOpen(false); }}>Delete</Button>
        </Drawer.Footer>
      </Drawer>
    </Example>
  );
...
<Modal open={modalOpen} ...>...</Modal>`}
    >
      ...
      <Modal open={modalOpen} onOpenChange={setModalOpen} size="sm">
        ...
        <Modal.Footer>
          <Modal.Close><Button>OK</Button></Modal.Close>
        </Modal.Footer>
      </Modal>
    </Example>
  );
...
function NoHeaderExample() {
  ...
  return (
    ...
    >
      <Cluster>
        <Button variant="secondary" onClick={() => setOpen(true)}>Open (no Header)</Button>
      </Cluster>
